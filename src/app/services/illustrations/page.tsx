      ...
      <section className="!w-full bg-cover bg-center bg-black text-white pb-10" style={{ backgroundImage: 'url(/media/bg.0f5970d1.png)' }}>
        <div className="w-full h-full flex items-center justify-center py-48 relative bg-cover bg-center bg-no-repeat" style={{ backgroundImage: 'url(/media/Inner_bg.23beb686.jpg)' }}>
          <div className="flex flex-col justify-center items-center xl:max-w-6xl gap-8 font-semibold text-white">
            <span className="text-4xl text-center xl:text-7xl">Illustration <span className="text-default">Services</span></span>
            ...
            <nav aria-label="breadcrumb" className="">
              <ul className="container flex items-center space-x-2 text-18 font-semibold text-white py-1.5 px-2">
                ...
                <li className="flex items-center"><span className="mx-2">*</span><span className="text-default">Illustrations</span></li>
              </ul>
            </nav>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-[1fr,400px] gap-12 lg:gap-20">
          <div className="space-y-12">
            ...
            <div className="rounded-[32px] overflow-hidden">
              <Image src="/media/sec1.d2123dfe.png" alt="Business people" width={800} height={400} className="w-full object-cover"/>
            </div>

            {/* Content Section */}
            <div className="space-y-6">
              <p>Our illustration services bring your ideas to life with stunning, custom-made visuals. Whether it's book illustrations, digital artwork, brand mascots, infographics, or marketing materials, we create captivating designs that enhance your brand identity. Our skilled illustrators blend creativity with strategy to ensure your illustrations leave a lasting impact. Let us help you tell your story through art.</p>
              
              <h2 className="text-4xl lg:text-5xl text-white">Key <span className="text-default font-semibold">features</span> of <span>illustrations</span></h2>
              
              <p>Our illustration services provide unique and captivating artwork that brings your ideas to life. From custom digital illustrations to hand-drawn designs, we create visuals that enhance your brand's identity and storytelling. Whether it's for marketing campaigns, books, websites, or social media, our tailored illustrations capture attention and engage audiences, making complex ideas more accessible and memorable.</p>
              ...
              <div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
                <ul className="space-y-4 xl:max-w-lg">
                  <li className="flex items-center gap-3">
                    ...
                    Unique digital & hand-drawn illustrations for your brand.
                  </li>
                  <li className="flex items-center gap-3">
                    <span className="bg-transparent rounded-full border-2 p-1 border-default text-center flex !items-center !justify-center">
                      <span className="w-[4px] h-[4px] block bg-default rounded-full"></span>
                    </span>
                    Custom mascots and character designs.
                  </li>
                  <li className="flex items-center gap-3">
                    <span className="bg-transparent rounded-full border-2 p-1 border-default text-center flex !items-center !justify-center">
                      <span className="w-[4px] h-[4px] block bg-default rounded-full"></span>
                    </span>
                    Engaging visuals for books and publications.
                  </li>
                  <li className="flex items-center gap-3">
                    <span className="bg-transparent rounded-full border-2 p-1 border-default text-center flex !items-center !justify-center">
                      <span className="w-[4px] h-[4px] block bg-default rounded-full"></span>
                    </span>
                    Creative artwork for marketing and campaigns.
                  </li>
                  <li className="flex items-center gap-3">
                    <span className="bg-transparent rounded-full border-2 p-1 border-default text-center flex !items-center !justify-center">
                      <span className="w-[4px] h-[4px] block bg-default rounded-full"></span>
                    </span>
                    Infographics and data visualizations for clarity.
                  </li>
                  <li className="flex items-center gap-3">
                    <span className="bg-transparent rounded-full border-2 p-1 border-default text-center flex !items-center !justify-center">
                      <span className="w-[4px] h-[4px] block bg-default rounded-full"></span>
                    </span>
                    Scalable vector and hand-drawn artwork.
                  </li>
                </ul>
                <div className="h-full overflow-hidden">
                  <Image src="/media/main.28557fac.jpg" alt="Main Image Acciobyte" width={400} height={400} className="w-full h-[230px] aspect-square object-cover rounded-xl"/>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-[32px] overflow-hidden">
              <div className="grid md:grid-cols-1 gap-6">
                <h2 className="text-4xl lg:text-5xl text-white">Our <span className="text-default font-semibold">process</span> of illustrations</h2>
                <p>Our illustration process begins with understanding your vision and brand. We work closely with you to create custom concepts that align with your messaging and style. Using both traditional and digital techniques, we craft detailed artwork that resonates with your audience. Our team ensures each illustration is created with attention to detail and purpose, whether it's for marketing materials, infographics, or character designs. We provide revisions to ensure the final product perfectly fits your needs and enhances your brand's visual communication.</p>
                ...
                <div className="flex flex-col md:flex-row md:items-center gap-6">
                  <div className="bg-blackfade2 rounded-[32px] p-10 flex flex-col flex-1 md:order-1">
                    ...
                    <p className="leading-relaxed">We begin by understanding your vision, objectives, and audience. Our team conducts research to define the best illustration style and approach.</p>
                  </div>
                  <div className="relative aspect-[4/3] rounded-[32px] overflow-hidden flex-1 bg-red-400 md:order-2">
                    <Image src="/media/step1.80f7b475.jpg" alt="Discovery & Concept Development" width={400} height={300} className="w-full h-full object-cover"/>
                  </div>
                </div>
                ...
                <div className="flex flex-col md:flex-row md:items-center gap-6">
                  <div className="bg-blackfade2 rounded-[32px] p-10 flex flex-col flex-1 md:order-2">
                    ...
                    <h3 className="text-white text-2xl font-bold mb-4">Sketching & Storyboarding</h3>
                    <p className="leading-relaxed">We create initial sketches or storyboards to outline the structure and composition of the illustration, ensuring alignment with your expectations.</p>
                  </div>
                  <div className="relative aspect-[4/3] rounded-[32px] overflow-hidden flex-1 bg-red-400 md:order-1">
                    <Image src="/media/step2.102fe844.jpg" alt="Sketching & Storyboarding" width={400} height={300} className="w-full h-full object-cover"/>
                  </div>
                </div>
                ...
                <div className="flex flex-col md:flex-row md:items-center gap-6">
                  <div className="bg-blackfade2 rounded-[32px] p-10 flex flex-col flex-1 md:order-1">
                    ...
                    <h3 className="text-white text-2xl font-bold mb-4">Final Illustration & Detailing</h3>
                    <p className="leading-relaxed">Using industry-leading tools, we refine the sketches into high-quality, polished illustrations with detailed elements, colors, and textures.</p>
                  </div>
                  <div className="relative aspect-[4/3] rounded-[32px] overflow-hidden flex-1 bg-red-400 md:order-2">
                    <Image src="/media/step3.d9148d2c.jpg" alt="Final Illustration & Detailing" width={400} height={300} className="w-full h-full object-cover"/>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mx-auto !mt-24">
              ...
              <div className="space-y-4">
                <div className="border-b border-none rounded-[24px] overflow-hidden bg-[#111] data-[state=open]:bg-[#151515]">
                  <h3 className="flex">
                    <button type="button" className="flex flex-1 items-center justify-between text-sm font-medium transition-all text-left px-6 py-6 hover:no-underline group">
                      <span className="text-white text-xl font-semibold text-left">What types of illustrations do you offer?</span>
                ...
                <div className="border-b border-none rounded-[24px] overflow-hidden bg-[#111] data-[state=open]:bg-[#151515]">
                  <h3 className="flex">
                    <button type="button" className="flex flex-1 items-center justify-between text-sm font-medium transition-all text-left px-6 py-6 hover:no-underline group">
                      <span className="text-white text-xl font-semibold text-left">Can you match my brand's existing style?</span>
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-chevron-down h-4 w-4 shrink-0 text-muted-foreground transition-transform duration-200">
                        <path d="m6 9 6 6 6-6"></path>
                      </svg>
                    </button>
                ...
                <div className="border-b border-none rounded-[24px] overflow-hidden bg-[#111] data-[state=open]:bg-[#151515]">
                  <h3 className="flex">
                    <button type="button" className="flex flex-1 items-center justify-between text-sm font-medium transition-all text-left px-6 py-6 hover:no-underline group">
                      <span className="text-white text-xl font-semibold text-left">Do you offer revisions?</span>
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-chevron-down h-4 w-4 shrink-0 text-muted-foreground transition-transform duration-200">
                        <path d="m6 9 6 6 6-6"></path>
                      </svg>
                    </button>
                ...
                <div className="border-b border-none rounded-[24px] overflow-hidden bg-[#111] data-[state=open]:bg-[#151515]">
                  <h3 className="flex">
                    <button type="button" className="flex flex-1 items-center justify-between text-sm font-medium transition-all text-left px-6 py-6 hover:no-underline group">
                      <span className="text-white text-xl font-semibold text-left">How long does an illustration project take?</span>
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-chevron-down h-4 w-4 shrink-0 text-muted-foreground transition-transform duration-200">
                        <path d="m6 9 6 6 6-6"></path>
                      </svg>
                    </button>
